<?php
/**
 * Template part for displaying single ideas posts
 *
...
<?php // get custom fields
    ...
    $ideasDescription = get_field('ideas_description');
        ...
        <div class="entry-content">
            <div class="grid align-to-top">
                <div class="column two-third">
                    <?php if ($imageDisplayType === 'square') : ?>
                        <header>
                            ...
                            <?php 
                                // if there's a custom ideas description, use that
                                if ($ideasDescription) : echo '<p class="post-description">' . $ideasDescription . '</p>';
                    ...
                    <?php else : ?>
                        ...
                        <?php endif; ?> 
                        <div class="post-meta">                           
                            <?php if ($ideasDescription) : echo '<p class="post-description">' . $ideasDescription . '</p>';
                            else : echo '<p class="post-description">' . get_the_excerpt() . '</p>'; endif; ?>
                            <?php if (($imageDisplayType !== 'full') && ($authors)) : grc_posted_by($authors); grc_posted_on(); endif; ?>
                        </div>
                    <?php endif; ?>
                ...
                <div class="column third">
                    <?php // get more ideas posts to populate the 'more from GRC Ideas' sidebar
                    ...
                    $more_ideas = new WP_Query($args);
                    
                    if ( $more_ideas->have_posts() ) : ?>
                        <div class="other-posts">
                            <h2>More from GRC Ideas</h2>
                            <?php while ( $more_ideas->have_posts() ) :
                                $more_ideas->the_post(); 
                                $authors = get_field('post_author');
                                ?>
