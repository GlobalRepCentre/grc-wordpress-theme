<?php
/**
 * Template part for displaying single medical supply chains posts
 *
        ...
        <div class="entry-content">
            <div class="grid align-to-top">
                <div class="column two-third">
                    <?php if ($imageDisplayType === 'square') : ?>
                        <header>
                            ...
                            <?php 
                                // if there's a custom medical supply chains description, use that
                ...
                <div class="column third">
                    ...
                    $more_medicalchains = new WP_Query($args);
                    
                    if ( $more_medicalchains->have_posts() ) : ?>
                        <div class="other-posts">
                            <h2>More Medical Supply Chains Stories</h2>
                            <?php while ( $more_medicalchains->have_posts() ) :
                                $more_medicalchains->the_post(); 
                                $authors = get_field('post_author');
                                ?>
