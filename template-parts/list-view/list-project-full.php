<?php
/**
 * Template part for displaying a full-width project on the projects page
 *
...
<article class="column full">
    <div class="grid">
        <div class="column">
            <?php if ($externalLink) : grc_featured_image($externalLink, 'medium'); else: grc_featured_image(false, 'medium'); endif; ?>
        </div>
